...
export default function Hero() {
  return (
    <div className='w-full bg-gradient-to-br from-blue-50 to-white rounded-3xl p-8 md:p-12 flex flex-col-reverse md:flex-row items-center justify-between gap-8 shadow-sm border border-blue-100 overflow-hidden relative'>
      <div className='flex flex-col items-center md:items-start gap-6 flex-1 text-center md:text-left z-10'>
        <div className="flex flex-col gap-2">
            <h1 className='text-4xl md:text-5xl lg:text-6xl font-extrabold text-gray-900 tracking-tight'>
              Buy & Sell <br/>
              <span className='text-primary'>Everything</span> in <span className="text-gray-900">Tager</span>
            </h1>
            <p className='text-lg text-gray-600 max-w-lg'>
              The safest marketplace to find great deals or turn your unused items into cash. Join thousands of happy users today.
            </p>
        </div>
        ...
        <div className='flex items-center gap-4 w-full md:w-auto justify-center md:justify-start'>
          ...
          <button 
             onClick={() => document.getElementById('posts-container')?.scrollIntoView({ behavior: 'smooth' })}
        ...
        <div className="flex items-center gap-6 mt-2 opacity-80">
            <div className="flex flex-col">
                ...
                <span className="text-xs text-gray-500 uppercase font-bold tracking-wider">Active Users</span>
            </div>
             <div className="w-px h-8 bg-gray-300"></div>
             <div className="flex flex-col">
                <span className="text-2xl font-bold text-gray-900">50k+</span>
                <span className="text-xs text-gray-500 uppercase font-bold tracking-wider">Items Listed</span>
            </div>
        </div>

      </div>
      
      <div className='flex-1 relative w-full max-w-lg md:max-w-xl z-10'>
        <img 
            src='/hero.png' 
