          ...
          <div className="bg-gray-50 p-6 md:px-8 border-t border-gray-200">
            <div className="flex flex-col md:flex-row justify-between items-center gap-6">
              ...
              <div className="flex flex-col lg:flex-row items-center gap-4 w-full md:w-auto justify-end">
                {promoted && (
                  <div className="flex min-w-fit items-center gap-1 text-sm font-medium text-primary bg-primary/10 px-3 py-1.5 rounded-full border border-primary/30">
